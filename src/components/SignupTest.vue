       ...
       // signup () {
         //   this.$store.dispatch('signup', {email: this.email, password: this.password, password2: this.password2, photo: this.photo, family_name: this.family_name, given_name: this.given_name})
            ...
            signup () {
                ...
                this.$store.dispatch('signup', {email: this.email, password: this.password, password2: this.password2, family_name: this.family_name, photo: this.photo, given_name:this.given_name})

...
<div class="main1">
    <v-container>
        <v-layout column>
            <div class="main">
            <v-flex  class="display-2 text-xs-center my-5">Everything uou need for your next hike</v-flex>
            </div>
            <v-flex>
        <template>
        <v-progress-linear v-model="value"
      :buffer-value="bufferValue" color="green"></v-progress-linear>
        </template>
...
<style scoped>
.main{
    background: linear-gradient(to right ,#60cc45,#0af74d)
}
.main1{
    background: linear-gradient(#22f2ef,#adb8b7)
}
</style>
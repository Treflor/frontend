...
<template>
    <v-container grid-list-lg>
        <v-layout row>
            <v-flex xs12 class="text-xs-center display-2 font-weight-black my-5">
                <v-card color="green" >Hikes/Treks</v-card></v-flex>
        </v-layout>
        <v-layout row wrap>
            <v-flex xs12 sm12 md4>
                <v-card color="#d2dbd6">
                    <v-img src="https://www.3wallpapers.fr/wp-content/uploads/2018/10/iPhone-wallpaper-mountains-chamonix.png" height="700px">
            ...
            <v-flex xs12 sm12 md4>
                <v-card color="#d2dbd6">
                 //   <v-img src="http://source.unsplash.com/6S27S6pZ6o0" height="500px">
                    <v-img src="https://i.pinimg.com/originals/56/fd/60/56fd60b2c22150dc321f47b659d55a99.jpg" height="700">
                        <v-container fill-height fluid>
                            <v-layout fill-height>
                                <v-flex xs12 align-end flexbox>
            ...
            <v-flex xs12 sm12 md4>
                <v-card color="#d2dbd6">
                    <v-img src="https://i.pinimg.com/originals/c2/47/e9/c247e913a0214313045a8a5c39f8522b.jpg" height="700px">
                        <v-container fill-height fluid>
                            <v-layout fill-height>
                                <v-flex xs12 align-end flexbox>
    ...
    <v-container grid-list-lg>
        ...
        <v-layout row wrap>
            <v-flex xs12 sm12 md4>
                <v-card>
                    <v-responsive>
                        <v-img src="https://images.unsplash.com/photo-1545161296-d9c2c241f2ad?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=334&q=80" height="500px">
                            <v-container fill-height fluid>
                                <v-layout fill-height>
                                    <v-flex xs12 align-end flexbox>
                                        <span class="headline white--text">Hike #1</span>
                                    </v-flex>
                                </v-layout>
                            </v-container>
                        </v-img>
            ...
            <v-flex xs12 sm12 md4>
                <v-card>
                    <v-responsive>
                        <v-img src="https://images.unsplash.com/photo-1476223003403-c9b4e5521f47?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=334&q=80" height="500px">
                            <v-container fill-height fluid>
                                <v-layout fill-height>
                                    <v-flex xs12 align-end flexbox>
                                        <span class="headline white--text">Hike #2</span>
                                    </v-flex>
                                </v-layout>
                            </v-container>
                        </v-img>
            ...
            <v-flex xs12 sm12 md4>
                <v-card>
                    <v-responsive>
                        <v-img src="https://images.unsplash.com/photo-1551541035-4e0fd119e2f0?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=400&q=80" height="500px">
                            <v-container fill-height fluid>
                                <v-layout fill-height>
                                    <v-flex xs12 align-end flexbox>
                                        <span class="headline white--text">Hike #3</span>
                                    </v-flex>
                                </v-layout>
                            </v-container>
                        </v-img>
